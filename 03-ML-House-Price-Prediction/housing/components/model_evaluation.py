...
from housing.entity.artifact_entity import ModelTrainerArtifact, ModelEvaluationArtifact, DataIngestionArtifact, DataValidationArtifact
...
class ModelEvaluation:
    ...
    def __init__(self,
        ...
        try:
            logging.info(f"{'=='*20} Model Evaluation Log Started {'==20'*20}")
    ...
    def update_evaluation_report(self, model_evaluation_artifact: ModelEvaluationArtifact):
        try:
            ...
            if BEST_MODEL_KEY in model_eval_content:
                MODEL_PATH_KEY: model_eval_content[BEST_MODEL_KEY]
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        try:
            ...
            logging.info(f"Dropped target column from the dataframe")
            ...
            if metric_info_artifact.index_number == 1:
                metric_evaluation_artifact = ModelEvaluationArtifact(evaluated_model_path=trained_model_file_path,
                                                                     is_model_accepted=True)
                self.update_evaluation_report(model_evaluation_artifact)
                logging.info(f"Model Accepted. model eval rtifact {model_evaluation_artifact} created")
            else:
